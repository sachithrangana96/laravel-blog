                ...
                <div class="panel-body">
                   ...
                   <form class="form-horizontal" method="POST" action="{{url('/addPost')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" type="text" class="form-control" name="post_body" value="{{ old('email') }}" ></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="profile_pic" type="file" class="form-control" name="post_image" >
